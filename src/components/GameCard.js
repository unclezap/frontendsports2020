        ...
        return (
            <div>
                ...
                >
                    ...
                    : null}
                    {this.state.clicked && !this.state.removed && !this.state.changedPast ? <button className="text-center" type="submit" onClick={this.removeAnalysis} >Remove this analysis!</button> : null}
